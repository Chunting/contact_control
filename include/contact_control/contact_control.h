...
public:
    ...
    balance(Contact::Dimension lDim, Contact::Dimension fDim, bool inWorld, double leverArm, Contact::Dimension mDim,
            double mSpeed, double fMax, double tMax);
    ...
    balanceAsync(Contact::Dimension lDim, Contact::Dimension fDim, bool inWorld, double leverArm,
...
private:
    ...
    int ft_y_direction;
    int ft_z_direction;
    int travel_x_direction;
    int travel_y_direction;
    int travel_z_direction;
